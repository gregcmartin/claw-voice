...
# Get config from .env
TOKEN=$(grep ALERT_WEBHOOK_TOKEN /home/lj/dev/jarvis-voice/.env | cut -d '=' -f2)
PORT=$(grep ALERT_WEBHOOK_PORT /home/lj/dev/jarvis-voice/.env | cut -d '=' -f2)
TAILSCALE_IP=$(grep TAILSCALE_IP /home/lj/dev/jarvis-voice/.env | cut -d '=' -f2)
