...
# Replace /home/lj/ with $HOME/ or ~/ in all markdown files
echo "🔧 Fixing file paths..."
find . -name "*.md" -type f -not -path "./node_modules/*" -exec sed -i 's|/home/lj/dev/jarvis-voice|./jarvis-voice|g' {} \;
find . -name "*.md" -type f -not -path "./node_modules/*" -exec sed -i 's|/home/lj/|~/|g' {} \;
